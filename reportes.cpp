...
void reporteAsistenciaPorFechas() {
    ...
    std::cout << "Ingrese fecha desde (dd/mm/aaaa): ";
    std::cin.getline(desde, 11);
    std::cout << "Ingrese fecha hasta (dd/mm/aaaa): ";
...
void reporteHorasTrabajadasPorEmpleado() {
    ...
    std::cout << "Total trabajado: " << (totalMinutos / 60) << " horas y " << (totalMinutos % 60) << " minutos.\n";
}
